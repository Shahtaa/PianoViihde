...
function Navbar() {
    ...
    const menuItems = (
        ...
        >
            <Button color="inherit" component={Link} to="/" onClick={() => setOpenDrawer(false)}>
                ETUSIVU
            </Button>
            <Button color="inherit" component={Link} to="/services" onClick={() => setOpenDrawer(false)}>
                PALVELUT
            </Button>
            <Button color="inherit" component={Link} to="/pianists" onClick={() => setOpenDrawer(false)}>
                PIANISTIT
            </Button>
            <Button color="inherit" component={Link} to="/artists" onClick={() => setOpenDrawer(false)}>
                ARTISTIT
            </Button>
            <Button color="inherit" component={Link} to="/media" onClick={() => setOpenDrawer(false)}>
                MEDIA
            </Button>
            <Button color="inherit" component={Link} to="/contact" onClick={() => setOpenDrawer(false)}>
                OTA YHTEYTTÄ
            </Button>
        </Box>
    );
